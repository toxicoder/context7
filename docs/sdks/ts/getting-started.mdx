...
`@toxicoder/context7-sdk` is a TypeScript SDK for Context7, enabling easier access to library documentation with full type coverage.

Using `@toxicoder/context7-sdk` you can:
...
You can find the Github Repository [here](https://github.com/toxicoder/context7/tree/master/packages/sdk).
...
```shell pnpm
pnpm add @toxicoder/context7-sdk
```

```shell yarn
yarn add @toxicoder/context7-sdk
```

```shell bun
bun add @toxicoder/context7-sdk
```
...
```typescript
import { Context7, Context7Error } from "@toxicoder/context7-sdk";
