...
Install the Context7 MCP automatically for any client via [Smithery](https://smithery.ai/server/@toxicoder/context7-mcp):

```bash
npx -y @smithery/cli@latest install @toxicoder/context7-mcp --client <CLIENT_NAME> --key <YOUR_SMITHERY_KEY>
```

Get your Smithery key from your account at [smithery.ai](https://smithery.ai/server/@toxicoder/context7-mcp).
...
<AccordionGroup>
  ...
  <Accordion title="Augment Code" icon="a">
    **Via UI**:
    ...
    2. Click **+ Add MCP**
    3. Enter command: `npx -y @toxicoder/context7-mcp@latest`
    4. Name: **Context7**
  ...
  <Accordion title="OpenAI Codex" icon="openai">
    ...
    **macOS**: Use full Node.js path if needed:
    ...
    args = [
      "/Users/yourname/.nvm/versions/node/v22.14.0/lib/node_modules/@toxicoder/context7-mcp/dist/index.js",
      "--transport", "stdio", "--api-key", "YOUR_API_KEY"
    ]
    ```
...
Install the [context7.mcpb](https://github.com/toxicoder/context7/blob/master/mcpb/context7.mcpb) file. See [MCP bundles docs](https://github.com/anthropics/mcpb#mcp-bundles-mcpb) for details.
