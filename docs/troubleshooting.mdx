...
- Update to the latest Context7 MCP package (`@toxicoder/context7-mcp@latest`)
...
```json
{
  "mcpServers": {
    "context7": {
      "command": "npx",
      "args": ["-y", "@toxicoder/context7-mcp@latest", "--api-key", "YOUR_API_KEY"]
    }
  }
}
```
...
1. **Check GitHub Issues**: Search for similar problems at [github.com/toxicoder/context7/issues](https://github.com/toxicoder/context7/issues)
